...
python -u train.py --name raft-sintel --stage sintel --validation sintel --restore_ckpt checkpoints/raft-sintel.pth --gpus 0 1 --num_steps 200000 --batch_size 4 --lr 0.000125 --image_size 368 768 --wdecay 0.00001 --gamma=0.85 --output $OUTPUTS >>$OUTPUTS/main_stdout.log 2>>$OUTPUTS/main_stderr.log
